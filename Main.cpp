...
int main()
{
    ...
    unsigned char change[9] = "chanSEED";

    int alice_secret = 123;
    int bob_secret = 123;
    ...
    cout << "\nThe execution time of the crypto stack is: " << chrono::duration_cast <std::chrono::nanoseconds> (t2 - t1).count() << "ns\n";
